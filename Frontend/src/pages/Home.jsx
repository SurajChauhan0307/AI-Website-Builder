    ...
    <>
        ...
        <section className='relative min-h-screen bg-[#050505] text-white overflow-hidden'>
            ...
            <div className='relative z-10 max-w-7xl mx-auto px-6 pt-32 pb-20 text-center'>
                ...
                <span className='bg-gradient-to-r from-purple-400 to-indigo-500 bg-clip-text text-transparent'>AI in Second</span>
                </motion.h1>
                ...
                >
                    <button className='flex items-center justify-center gap-2 px-6 py-3 bg-indigo-500 hover:bg-indigo-600 rounded-xl font-semibold transition'>Start Building<ArrowRight size={18}/>
                    </button>
