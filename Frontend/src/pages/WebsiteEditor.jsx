...
const WebsiteEditor = () => {
    ...
    // FIXED INTERVAL (no multiple intervals issue)
    useEffect(() => {
                ...
                <div className='p-3 border-t border-white/10'>
                    <div className='flex gap-2'>
                        <textarea
                            ...
                            className='flex-1 resize-none rounded-2xl px-4 py-3 bg-white/5 border border-white/10 outline-none'
                        />
                ...
                {showChat && (
                    ...
                    >
                        ...
                        <div className='p-3 border-t border-white/10 flex gap-2'>
                            ...
                            <button onClick={handleUpdate} className='px-4 py-3 bg-white text-black rounded-2xl'>
                                <Send size={18} />
                            </button>
                        </div>
                    </motion.div>
